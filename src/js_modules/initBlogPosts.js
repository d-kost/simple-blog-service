...
const initBlogPosts = [
  {
    id: 0,
    authorNickname: initUsers[0].nickname,
    likes: [],
  ...
  },
  {
    ...
    likes: [initUsers[2].nickname],
    text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. ' +
      'Pellentesque eget erat nec est vehicula aliquam. \n\n' +
      'Vestibulum sit amet pulvinar purus. Cras molestie quis nibh et hendrerit.'
  },
  {
    id: 2,
    authorNickname: initUsers[0].nickname,
    likes: [initUsers[0].nickname, initUsers[2].nickname],
    text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus pellentesque ' +
    'lorem in ligula lacinia eleifend. Duis at eleifend purus. Aenean eget ex ut odio finibus ' +
    'laoreet eget at nibh. Maecenas sed neque nec justo pretium convallis non sed ex. Proin dignissim ' +
    'lacinia accumsan. Mauris lobortis.'
  },
  {
    id: 3,
